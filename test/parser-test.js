...
describe('parser', function() {
	...
	it('should extract Russian quotes', function() {
		var text = 'Генри Киссинджер: «Я не сомневаюсь, что русские взламывают нас. И я надеюсь, что мы совершаем некоторые атаки там».\n';
		text += 'В интервью телеканалу CBS News Киссинджер заявил, что «вероятно, каждая разведывательная служба проводит хакерские атаки на территории других стран».\n';
		text += 'Киссинджер также сравнил российского президента Владимира Путина с героем романа Фёдора Достоевского «Преступление и наказание».\n';
		text += 'Генри Киссинджер: «Он холодный калькулятор национального интереса России, как он его понимает, и который, он считает, вероятно правильно, имеет несколько уникальных особенностей».\n';
		text += 'Он также добавил, что для Путина очень важен «вопрос идентичности России», цитирует РИА Новости.';
